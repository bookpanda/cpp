#ifndef INTERRUPTIBLE_WAIT_ANY_H
#define INTERRUPTIBLE_WAIT_ANY_H
...
// #include "11-interruptible-wait.h"
...
template <typename Lockable> void interruptible_wait(std::condition_variable_any &cv, Lockable &lk) {
    this_thread_interrupt_flag.wait(cv, lk);
}

#endif // INTERRUPTIBLE_WAIT_ANY_H